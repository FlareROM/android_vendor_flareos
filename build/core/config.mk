...
FRAMEWORK_LINEAGE_API_NEEDS_UPDATE_TEXT := $(TOPDIR)vendor/flareos/build/core/apicheck_msg_current.txt

BUILD_RRO_SYSTEM_PACKAGE := $(TOPDIR)vendor/flareos/build/core/system_rro.mk

# Rules for MTK targets
include $(TOPDIR)vendor/flareos/build/core/mtk_target.mk

# Rules for QCOM targets
include $(TOPDIR)vendor/flareos/build/core/qcom_target.mk
